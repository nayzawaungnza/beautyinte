        ...
        <main class="projects-grid">
            ...
            if ($user_res->num_rows > 0) {
                while ($data = $user_res->fetch_assoc()) {
                    if ($data['name'] === "နိုနို") {  // name ကိုစစ်မယ်
            ?>
                        <article class="project">
                            <!-- ပုံဘက် -->
                            <div class="media">
                                <img src="../uplode/<?= htmlspecialchars($data['image']) ?>" alt="<?= htmlspecialchars($data['name']) ?>" style="width:370px; height:480px;">
                            </div>
                            ...
                            <div class="content">
                                ...
                                <p style="font-weight:bold;">
                                    အောင်လက်မှတ် -</p>
                                <img src="../uplode/bb.jpg" style="width:220px; height:150px;margin-left:120px;">
                            </div>
